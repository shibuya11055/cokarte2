...
RSpec.describe '顧客データの可視性', type: :request do
  ...
  it '顧客一覧に他ユーザーの顧客は表示されない' do
    ...
    create(:client, user: user_a, last_name: '山田', first_name: '太郎')
    create(:client, user: user_b, last_name: '佐藤', first_name: '花子', birthday: '1992-02-02')
  ...
  it '他ユーザーの顧客詳細は404になる' do
    ...
    own_client = create(:client, user: user_a, last_name: '田中', first_name: '次郎', birthday: '1991-03-03')
    other_client = create(:client, user: user_b, last_name: '高橋', first_name: '三郎', birthday: '1993-04-04')
  ...
  it '他ユーザーの顧客編集・更新も404になる' do
    ...
    other_client = create(:client, user: user_b, last_name: '中村', first_name: '四郎', birthday: '1994-05-05')
