...
Rails.application.configure do
  ...
  # Use simple in-process job backend to avoid extra DB requirements in production.
  # If you want Solid Queue, run queue DB migrations and switch back to :solid_queue.
  ...
  config.action_mailer.default_url_options = { host: "https://cokarte.onrender.com", protocol: "https" }
